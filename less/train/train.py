...
from transformers import (AutoModelForCausalLM, AutoTokenizer,
                          ...
                          set_seed)
sys.path.append('/root/autodl-tmp/GREATS/')
...
def main():
    ...
    ########## 设置result的路径 ########
    training_args.result_dir = '/root/autodl-tmp/GREATS/GREATS_Result/'
